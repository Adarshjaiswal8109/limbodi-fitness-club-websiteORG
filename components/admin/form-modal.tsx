...
export interface FormFieldDef {
  key: string;
  label: string;
  type: 'text' | 'textarea' | 'select' | 'toggle' | 'number' | 'image' | 'tags';
  required?: boolean;
  placeholder?: string;
  hint?: string;
                    ...
                    <>
                      ...
                      {field.type === 'textarea' ? (
                        ...
                        <div className="space-y-2">
                          ...
                          />
                          {data[field.key] && (
                            <img src={data[field.key]} alt="Preview" className="h-24 w-24 rounded-xl object-cover border border-black/10" />
                          )}
                        </div>
                      ) : field.type === 'tags' ? (
                        <TagsInput
